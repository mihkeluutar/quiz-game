...
export const HostDashboard = () => {
  ...
  if (quiz.status === 'FINISHED') {
    ...
    return (
      <div className="p-8 space-y-12 container mx-auto w-full animate-in fade-in duration-500">
  ...
  return (
    <div className="fixed inset-0 flex flex-col bg-white">
      ...
      <div className="bg-white border-b shadow-sm z-10">
          <div className="p-4 flex justify-between items-center border-b container mx-auto w-full">
          ...
          <div className="bg-slate-50 border-b">
              <div className="flex overflow-x-auto p-2 gap-2 scrollbar-hide container mx-auto">
                  {blocks.map((b, idx) => {
      ...
      <div className="flex-1 overflow-auto bg-slate-50">
        <div className="p-4 space-y-8 container mx-auto w-full pt-8">
        {quiz.phase === 'QUESTION' && currentQuestion ? (
            ...
            <div className="space-y-6 container mx-auto w-full animate-in fade-in duration-500">
                <div className="space-y-2">
            ...
            {/* STYLE_OVERRIDE: Use 50vh for centered hero feel */}
      ...
      {quiz.phase !== 'QUESTION' && (
          /* STYLE_OVERRIDE: Top shadow for sticky footer */
