...
export const HostDashboard = () => {
                                                            ...
                                                            <div className="space-y-4 pt-2">
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <Table>
                                                                        <TableHeader>
                                                                            <TableRow>
                                                                                <TableHead className="max-w-52">Participant</TableHead>
  ...
  return (
    <div className="fixed inset-0 flex flex-col bg-white">
            ...
            <div className="flex flex-col items-center justify-center min-h-[500px] space-y-12 animate-in fade-in duration-700">
                 ...
                 {quiz.phase === 'AUTHOR_REVEAL' ? (
                     <div className="relative animate-in zoom-in spin-in-3 duration-700">
                         ...
                         <div className="relative bg-white p-12 rounded-3xl shadow-2xl border-4 border-green-100 flex flex-col items-center gap-4 text-center min-w-80">
      ...
      {quiz.phase !== 'QUESTION' && (
          // STYLE_OVERRIDE: shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.1)] is a custom top shadow for the sticky footer
