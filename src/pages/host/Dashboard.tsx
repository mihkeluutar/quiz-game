    ...
    <div className="fixed inset-0 flex flex-col bg-white">
      ...
      <div className="flex-1 overflow-auto bg-slate-50">
        ...
        {quiz.phase === 'QUESTION' && currentQuestion ? (
            ...
            // STYLE_OVERRIDE: 32rem (512px) approximates original 500px min-height
            <div className="flex flex-col items-center justify-center min-h-[32rem] space-y-12 animate-in fade-in duration-700">
                 <div className="text-center space-y-4">
      ...
      {quiz.phase !== 'QUESTION' && (
          // STYLE_OVERRIDE: Top shadow not available in standard Tailwind
